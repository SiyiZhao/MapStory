...
python mapstory.py --db "$DB" add --time=-195-06-01 --time-note "汉十二年四月甲辰二十五日" --lat 34.34 --lon 108.94 --location-note "长乐宫（今西安汉长安城）" --event "刘邦崩于长乐宫；卢绾闻讯逃匈奴，被冒顿封东胡卢王" --persons "刘邦, 卢绾, 冒顿" --priority fact